   ...
   public String[] getTimeStrings() {
	...
	public static void main(String[] args) {
		...
		try {
                    ...
                    x = new DataContainer("office.csv");
//			System.out.println(Arrays.toString(x.getData("Tcorridor")));
                        System.out.println((x.getAvailableVariables()));
//                        System.out.println((x.getDates()));
//                        System.out.println("Number of data: " + x.getNumberOfSamples());
//                        System.out.println("Number of variables: " + x.getNumberOfVariables());
//                        dataContainer.getAvailableVariables();
                    for (int i = 0; i < 10; i++) {
                System.out.println(x.getAvailableVariables()[i]);
            }
